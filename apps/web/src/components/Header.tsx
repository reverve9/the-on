      ...
      <div className="max-w-[1280px] mx-auto px-5">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-10 py-2.5 bg-gray-100 border-0 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link to="/register" className="text-gray-600 hover:text-gray-900">회원가입</Link>
          </div>
        </div>
